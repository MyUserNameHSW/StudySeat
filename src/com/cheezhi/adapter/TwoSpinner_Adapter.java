...
public class TwoSpinner_Adapter extends BaseAdapter {
	Context context;
	List<Integer> list;
	LayoutInflater mInflater;
	ViewHolder mHolder;

	public TwoSpinner_Adapter(Context context, List<Integer> list) {
		super();
	...
	public View getView(int arg0, View arg1, ViewGroup arg2) {
		...
		mHolder.tv1.setText(MyMethod.nameName(list.get(arg0)));
		return arg1;
	}
